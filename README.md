...
![VirtKick panel](https://raw.github.com/syskillerdev/virtkick/master/screenshot.png)
...
- [virtkick-package](https://github.com/syskillerdev/virtkick-package), click & play binary packages
- [virtkick-starter](https://github.com/syskillerdev/virtkick-starter), one-click installer for development environments
- [virtkick-webapp](https://github.com/syskillerdev/virtkick-webapp), VirtKick user & admin web panel
- [virtkick-backend](https://github.com/syskillerdev/virtkick-backend), a VirtKick backend that talks with hypervisors
- [virtkick-proxy](https://github.com/syskillerdev/virtkick-proxy), an HTTP reverse proxy with support for noVNC
- [virtkick-website](https://github.com/syskillerdev/virtkick-website), a website at [virtkick.io](https://www.virtkick.io/)
- [virtkick-prototype](https://github.com/syskillerdev/virtkick-prototype), a static prototype at [demo.virtkick.io](https://demo.virtkick.io/)
